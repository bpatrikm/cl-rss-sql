...
(defpackage cl-rss-sql
  (:export refresh-channels channel publication edition latest-edition idchannel idpublication url name site published latest-view fresh-p title desc *db-cred*)
  (:use :cl :clsql :xmls))
